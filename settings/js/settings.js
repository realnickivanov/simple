    ...
    var viewModel = {
        ...
        defaultTranslations: {
            ...
            ua: [
                    ...
                    { key: "[tracking and tracing skip reporting]", value: "Почати курс без відправки результатів" },
                    { key: "[tracking and tracing start]", value: "Почати курс та відстежувати мій прогрес" },
                    { key: "[tracking and tracing error]", value: "Помилка" },
                    { key: "[tracking and tracing error hint]", value: "Якщо Ви будете продовжувати курс, прогрес не відправлятиметься. Краще спробуйте ще раз." },
                    { key: "[tracking and tracing restart course]", value: "Спробувати ще раз" },
                    { key: "[tracking and tracing continue anyway]", value: "Продовжити без відстеження результатів" },
