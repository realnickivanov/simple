    ...
    window.getTranslations = function () {
        return {
            ...
            pt: [
               ...
               { key: '[learning objectives]', value: 'Objetivos de aprendizado:' },
               { key: '[start]', value: 'Iniciar curso' },
               { key: '[home]', value: 'Home' },
               { key: '[learning content]', value: 'Conteúdo de aprendizagem' },
               { key: '[submit]', value: 'Submeter' },
               { key: '[try again]', value: 'Tente novamente' },
               { key: '[next]', value: 'Próximo' },
               { key: '[correct answer]', value: 'Resposta correta' },
               { key: '[incorrect answer]', value: 'Resposta incorreta' },
               { key: '[previous question]', value: 'anterior' },
               { key: '[next question]', value: 'próxima' },
               { key: '[of]', value: 'de' },
               { key: '[to complete]', value: 'para completar' },
               { key: '[text matching question hint]', value: 'Arraste os itens da coluna da direita para a esquerda para casar os pares' },
               { key: '[text matching question drop here]', value: 'Solte aquí' },
               { key: '[statement question true text]', value: 'TRUE' },
               { key: '[statement question false text]', value: 'FALSE' },
               { key: '[drag and drop question all texts are placed]', value: 'Todos os textos estão posicionados' },
               { key: '[drag and drop question drop here]', value: 'Solte aquí' },
               { key: '[fill in the blank choose answer]', value: 'Selecione a resposta...' },
               { key: '[thank you message]', value: 'Obrigado, você pode fechar a página agora' },
               { key: '[save my current progress]', value: "Salve meu progresso atual" },
               { key: '[progress has been saved]', value: "Progresso foi salvo!" },
               { key: '[progress not saved]', value: "Seu progresso no curso ainda não foi salvo! Se você deseja salvá-lo agora:\n  1. Pressione \"Permanecer nesta página\"\n  2. Pressione \"Salve meu progresso atual\" no topo da  página do curso.\nOu Pressione \"Deixar esta página\" para fechar o curso sem salvar seu progresso." },
               { key: '[progress cannot be saved]', value: "Progresso do curso não pode ser salvo. Tente novamente ou contate seu professor se o problema persistir." },
               { key: '[there are no questions]', value: 'Sem perguntas' },
               { key: '[browser not supported]', value: 'Seu navegador atualmente não é suportado.' },
               { key: '[browser not supported hint]', value: 'Não se preocupe, existe uma correção simples. Tudo o que você precisa fazer é clicar em um dos ícones abaixo e seguir as instruções.' },
               { key: '[page not found title]', value: 'Página não encontrada (404)' },
               { key: '[page not found message]', value: "Desculpe, a página que você está tentando acessar não foi encontrada. Tente verificar a URL por erros de digitação, use a navegação acima ou clique no link 'Home' abaixo." },
               { key: '[tracking and tracing header]', value: 'Suas credencias para acompanhar o progresso' },
               { key: '[tracking and tracing hint]', value: 'Favor entrar com suas credenciais e clicar em "Iniciar e relatar meus resultados" habilitar o acompanhamento do progresso. Ou então, clique "Não reportar,apenas iniciar".' },
               { key: '[tracking and tracing name field]', value: 'Seu nome' },
               { key: '[tracking and tracing email field]', value: 'Seu e-mail' },
               { key: '[tracking and tracing name is not valid]', value: 'Preencha com seu nome' },
               { key: '[tracking and tracing email is not valid]', value: 'Digite um e-mail válido' },
               { key: '[tracking and tracing skip reporting]', value: 'Não relatar, apenas iniciar' },
               { key: '[tracking and tracing start]', value: 'Iniciar e relatar meus resultados' },
               { key: '[tracking and tracing error]', value: 'Algo está errado' },
               { key: '[tracking and tracing error hint]', value: 'Se você continuar sem re-iniciar, seus resultados do aprendizado não serão relatados' },
               { key: '[tracking and tracing restart course]', value: 'Re-iniciar curso' },
               { key: '[tracking and tracing continue anyway]', value: 'Continuar mesmo assim' },
               { key: '[tracking and tracing reporting progress]', value: 'Relatando os resultados...' }
            ],
        };
    }
});
