...
var addBuildVersion = function () {
    var doReplace = function (file, callback) {
        ...
        fileContent = fileContent
            ...
            .replace(/\.(jpeg|jpg|png|gif|css|js|html)([?])/gi, '.$1?v=' + buildVersion + '&')          // add build version to resource without query param
            .replace(/\.(jpeg|jpg|png|gif|css|js|html)([\s\"\'])/gi, '.$1?v=' + buildVersion + '$2')    // add build version to resource with existing query param
